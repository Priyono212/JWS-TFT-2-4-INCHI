...
//    ID = 0x9329;                             // force ID I2C device found at address 0x57  !
...
void loop(void) {
  ...
  ///////// Menampilkan hari///////////
  tft.fillRect(0,30,319,25,GREEN);
  tft.setTextColor(BLACK,GREEN);
  tft.setTextSize(2);
  tft.setCursor(ss*2.1,34);
  tft.print(F("HARI:"));
...
void fiil(){
      ...
      */
      tft.fillRect(0, 60, 155, 25, GREEN);
      tft.fillRect(160, 60, 310, 25, BLUE);
      tft.fillRect(160, 90, 310, 25, CYAN);
      tft.fillRect(160, 120, 310, 25, GREEN);
      tft.fillRect(160, 150, 310, 25, YELLOW);
      tft.fillRect(160, 180, 310, 25, RED);
      tft.fillRect(160, 210, 310, 25, MAGENTA);
